            ...
            <DialogContent dividers sx={{pl: '15px', pr: '15px'}}>
                <Typography variant='h6' sx={{color: 'blue', fontWeight: 'bolder'}}>Điều dưỡng</Typography>
                    <Box sx={{pl: '5px', pr: '5px'}}>
                        ...
                        <Typography>Nhấn phím f2 hoặc nút Đăng ký (F2) trên màn hình</Typography>
                        <Typography sx={{color: 'green', fontWeight: 'bolder'}}>Làm mới form thông tin đăng ký khám</Typography>
                        <Typography>Nhấn phím f4 hoặc nút Làm mới (F4) trên màn hình</Typography>
                        <Typography sx={{color: 'green', fontWeight: 'bolder'}}>Tìm bệnh cũ</Typography>
                        <Typography>Nhấn phím f8 hoặc nút Bệnh cũ (F8) trên màn hình, sau khi nhập thông tin và tìm được bệnh nhân, click đúp thông tin bệnh nhân để form thông tin đăng ký khám nhận dữ liệu</Typography>
